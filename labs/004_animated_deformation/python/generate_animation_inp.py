#!/usr/bin/env python3
"""
Generate a CalculiX input file for an animated cantilever shell deformation.

This lab prints displacements for all nodes so that a Python/Pillow script
can create an animated deformation GIF.
"""
...
def main() -> None:
    ...
    out_file = input_dir / f"{CASE_NAME}.inp"
    ...
    all_nodes = [nid for nid, _x, _y, _z in nodes]
    ...
    with out_file.open("w", encoding="utf-8") as f:
        f.write("*HEADING\n")
        f.write("Lab 004 - Animated cantilever shell deformation\n")
        f.write("Generated by python/generate_animation_inp.py\n")
        f.write("\n")
